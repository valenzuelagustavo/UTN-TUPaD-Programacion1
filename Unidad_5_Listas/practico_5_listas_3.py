...
for i in range(len(lista_numeros)):
    if lista_numeros[i] % 2 == 0: num_pares.append(lista_numeros[i])   #Añadimos los pares
    elif lista_numeros[i] % 2 != 0: num_impares.append(lista_numeros[i])    #Añadimos los impares
